...
import (
	...
	k8sv1alpha1 "github.com/Kubewell/kubewell-ingress-operator/api/v1alpha1"
	"github.com/Kubewell/kubewell-ingress-operator/controllers"
...
func main() {
	...
	options := ctrl.Options{
		...
		LeaderElectionID:       "ca5c10a7.kubewell.org",
	...
	if err = (&controllers.kubewellIngressControllerReconciler{
		Client:       mgr.GetClient(),
		Scheme:       mgr.GetScheme(),
		SccAPIExists: sccAPIExists,
		Mgr:          mgr,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "kubewellIngressController")
		os.Exit(1)
	}
